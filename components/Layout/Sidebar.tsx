...
export default function Sidebar() {
  ...
  const menuItems = useMemo(() => [
    ...
    { icon: BarChart, label: t('spadesfi'), path: '/' },
    { icon: Grid3x3, label: t('ddrop'), path: '/' },
    { icon: Search, label: t('explore'), path: '/' },
    { icon: RefreshCw, label: t('trending'), path: '/' },
    { icon: Calendar, label: t('events'), path: '/' },
    { icon: File, label: t('news'), path: '/' },
    { icon: User, label: t('dashboard'), path: '/' },
